...
def _prompt_capabilities() -> str:
    ...
    return (
        ...
        "- When you finish the work a to-do tracks, mark it done with\n"
        "  manage_tasks in the same turn — don't leave it open for the next\n"
        "  wake cycle to re-surface as if it were still pending.\n"
